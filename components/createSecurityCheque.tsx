...
export default function SecurityChequeForm() {
  ...
  <Button
    className="group text-white px-2 py-2 rounded-lg border-0 transition-all duration-300 hover:scale-105 cursor-pointer"
    style={{ background: "linear-gradient(135deg, #1e293b 0%, #0f172a 100%)" }}
    onClick={() => router.push("/security-cheques")}
  >
    View All Cheques
  </Button>
</div>
